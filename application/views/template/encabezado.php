    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <li><a href="<?=base_url()?>index.php/buscarventa/formularioVentaGeneral/">General</a></li>
                <li><a href="<?=base_url()?>index.php/buscarventa/formularioVentaDetallada/">Detallado</a></li>
                <li class="divider"></li>
                <li><a href="<?=base_url()?>index.php/panel/formularioCuentas">Cuentas Por Pagar</a></li>
                </ul>
